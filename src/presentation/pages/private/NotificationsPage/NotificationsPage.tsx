...
const NotificationsPage: FC = () => {
  ...
  return (
    <>
      <main className="w-[90vw] mx-auto flex flex-col mt-8 lg:mt-0 h-[85vh]">
        <motion.div
          initial={{ opacity: 0, y: 10 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.25 }}
          className="flex-1 min-h-0 bg-white rounded-xl border border-gray-300 flex overflow-hidden"
        >
          {error ? (
